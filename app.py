...
# Setando a a parência padrão do sistema
ctk.set_appearance_mode("System")
ctk.set_default_color_theme("blue")


# Todo metodo deve ser iniciado na classe App para funcionar!
class App(ctk.CTk):
    def __init__(self):
        super().__init__()
        self.layout_config()
    ...
    def todo_sistema(self):
        ...
        title = ctk.CTkLabel(frame, text="Sistema de Cadastro de Clientes", font=("Century Gothic bold", 24),
                             text_color="#fff")
    ...
    #Criando o ficheiro Clientes.xlsx
        ...
        name_entry = ctk.CTkEntry(self, width=350, textvariable=name_value, font=("Century Gothic", 16),
                                  fg_color="transparent")
        contact_entry = ctk.CTkEntry(self, width=200, textvariable=contact_value, font=("Century Gothic", 16),
                                     fg_color="transparent")
        age_entry = ctk.CTkEntry(self, width=150, textvariable=age_value, font=("Century Gothic", 16),
                                 fg_color="transparent")
        address_entry = ctk.CTkEntry(self, width=200, textvariable=address_value, font=("Century Gothic", 16),
                                     fg_color="transparent")
        ...
        obs_entry = ctk.CTkTextbox(self, width=480, height=150, font=("arial", 18), border_color="#aaa", border_width=2,
                                   fg_color="transparent")

        # Labels

        lb_name = ctk.CTkLabel(self, text="Nome completo:", font=("Century Gothic bold", 16),
                               text_color=["#000", "#fff"])
        ...
        btn_clear = ctk.CTkButton(self, text="Limpar campos".upper(), command=clear, fg_color="#555",
                                  hover_color="#333")
